...
public class InstanceUpgradeServiceTest {
    ...
    public void shouldUpgradeInstanceSuccessfully() throws BadResponseException {
        ...
        String vfModuleUUID = "vfModuleUUID";
        ...
        when(upgradeRequest.getVfModuleUUID()).thenReturn(vfModuleUUID);
        ...
        assertEquals(requestCaptureValue.getReleaseName(), k8sRBProfileName + "-" + vfModuleUUID);
    }
