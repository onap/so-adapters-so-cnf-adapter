...
public class AaiRepository implements IAaiRepository {
	...
	public void update(KubernetesResource resource, AaiRequest aaiRequest) {
		...
		String payload = gson.toJson(k8sResource);
	...
	public void delete(AaiRequest aaiRequest) {
		...
		/* FIXME it should iterate over all related kubernetes resources
	...
	private RelationshipList getKubernetesResourceRelationshipList(final String cloudOwner, final String cloudRegionId,
														final String genericVnfId, final String vfModuleId) {
		RelationshipList relationshipList = new RelationshipList();
		List<Relationship> relationships = relationshipList.getRelationship();

		// kubernetes resource to generic-vnf relationship
		...
		// kubernetes resource to vf-module relationship
