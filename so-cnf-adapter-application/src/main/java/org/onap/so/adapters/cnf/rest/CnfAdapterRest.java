...
public class CnfAdapterRest {
    ...
    @Autowired
    public CnfAdapterRest(CnfAdapterService cnfAdapterService, CallbackClient callbackClient, MulticloudConfiguration multicloudConfiguration) {
    ...
    public DeferredResult<ResponseEntity> healthCheck(@RequestBody CheckInstanceRequest healthCheckRequest) {
        ...
        ForkJoinPool.commonPool().submit(() -> {
            ...
            List<HealthCheckInstanceResponse> instanceResponse = new ArrayList<>();
            instanceResponse.add(new HealthCheckInstanceResponse("infallible_sanderson", "Something", "UP"));
            instanceResponse.add(new HealthCheckInstanceResponse("gallant_hoover", "Something", "UP"));
            instanceResponse.add(new HealthCheckInstanceResponse("flamboyant_lederberg", "Something", "UP"));
